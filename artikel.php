...
<head>
    ...
    <!-- Canonical FINAL FIX -->
    <?php
    $canonical = "https://dealerhinoindonesia.com/artikel/";
    ?>
    ...
    <meta property="og:url" content="https://dealerhinoindonesia.com/artikel" />
    ...
    foreach ($artikel as $row) {
        ...
        $schemaItem = [
            ...
            "mainEntityOfPage" => [
                "@type" => "WebPage",
                "@id" => "https://dealerhinoindonesia.com/artikel/" . $slug
            ],
            "headline" => $judul,
            "description" => $excerpt,
            "image" => [
    ...
    $blogSchema = [
        ...
        "url" => $canonical ?? "https://dealerhinoindonesia.com/artikel",
